...
void *fnsort( void *arg )
{
    ...
    while( !quitting )
    {
        ...
        //printf("fnsort calling yeild2\n");
        mypthread_yield( );
    }
    //printf("fnsort calling exit1\n");
    mypthread_exit( 0 );
...
//        pList[i] = random( ) % (nListSize<<1);   // random list
    ...
    {
        //printf("Trying to acquire mutex %d\n", i+1);
